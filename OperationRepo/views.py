...
def business1(request):
    context = RequestContext(request)
    context_dict = {"business_id": "WIcDFpHEnC3ihNmS7-6-ZA", "full_address": "7605 E Pinnacle Peak Rd\nScottsdale, AZ 85255", "hours": {"Monday": {"close": "20:30", "open": "11:00"}, "Tuesday": {"close": "20:30", "open": "11:00"}, "Friday": {"close": "21:00", "open": "11:00"}, "Wednesday": {"close": "20:30", "open": "11:00"}, "Thursday": {"close": "20:30", "open": "11:00"}, "Saturday": {"close": "21:00", "open": "17:00"}}, "open": False, "categories": ["Thai", "Restaurants"], "city": "Scottsdale", "review_count": 21, "name": "Thai Pan Fresh Exotic Cuisine", "neighborhoods": [], "longitude": -111.9174872, "state": "AZ", "stars": 3.5, "latitude": 33.698649699999997, "attributes": {"Take-out": True, "Good For": {"dessert": False, "latenight": False, "lunch": True, "dinner": True, "brunch": False, "breakfast": False}, "Takes Reservations": False, "Delivery": False, "Parking": {"garage": False, "street": False, "validated": False, "lot": True, "valet": False}, "Wheelchair Accessible": True, "Outdoor Seating": False, "Attire": "casual", "Alcohol": "beer_and_wine", "Waiter Service": False, "Accepts Credit Cards": True, "Good for Kids": True, "Good For Groups": True, "Price Range": 2}, "type": "business"}
    return render_to_response('OperationRepo/business.html', context_dict, context)

def business2(request):
    context = RequestContext(request)
    context_dict = {"business_id": "70p94Ejeu1v5XlIkbKORYQ", "full_address": "3479 E Baseline Rd\nSte 18\nGilbert, AZ 85234", "hours": {"Monday": {"close": "19:00", "open": "09:00"}, "Tuesday": {"close": "19:00", "open": "09:00"}, "Friday": {"close": "19:00", "open": "09:00"}, "Wednesday": {"close": "19:00", "open": "09:00"}, "Thursday": {"close": "19:00", "open": "09:00"}, "Saturday": {"close": "19:00", "open": "09:00"}}, "open": "True", "categories": ["Hair Salons", "Beauty & Spas"], "city": "Gilbert", "review_count": 9, "name": "Salon Lola", "neighborhoods": [], "longitude": -111.75560249999999, "state": "AZ", "stars": 5.0, "latitude": 33.379065699999998, "attributes": {"Price Range": 2, "Parking": {"garage": "False", "street": "False", "validated": "False", "lot": "True", "valet": "False"}, "By Appointment Only": "True", "Accepts Credit Cards": "True", "Good for Kids": "True", "Wheelchair Accessible": "True"}, "type": "business"}
    return render_to_response('OperationRepo/business.html', context_dict, context)

def business3(request):
    context = RequestContext(request)
    context_dict = {"business_id": "WcGTSRku3mrVK7V9GKq4UQ", "full_address": "1084 S Gilbert Rd\nGilbert, AZ 85296", "hours": {}, "open": "True", "categories": ["Fast Food", "Tex-Mex", "Restaurants"], "city": "Gilbert", "review_count": 31, "name": "Chipotle Mexican Grill", "neighborhoods": [], "longitude": -111.790869, "state": "AZ", "stars": 4.0, "latitude": 33.329841999999999, "attributes": {"Take-out": "True", "Good For": {"dessert": "False", "latenight": "False", "lunch": "True", "dinner": "True", "brunch": "False", "breakfast": "False"}, "Noise Level": "average", "Good for Kids": "True", "Takes Reservations": "False", "Has TV": "False", "BYOB/Corkage": "yes_free", "Delivery": "False", "Ambience": {"romantic": "False", "intimate": "False", "touristy": "False", "hipster": "False", "divey": "False", "classy": "False", "trendy": "False", "upscale": "False", "casual": "False"}, "Parking": {"garage": "False", "street": "False", "validated": "False", "lot": "True", "valet": "False"}, "Wheelchair Accessible": "True", "Corkage": "False", "Outdoor Seating": "True", "Attire": "casual", "Alcohol": "none", "Waiter Service": "False", "Accepts Credit Cards": "True", "Good For Kids": "True", "Good For Groups": "False", "Price Range": 1}, "type": "business"}
    return render_to_response('OperationRepo/business.html', context_dict, context)

# Reviews
def review1(request):
    context = RequestContext(request)
    context_dict = {"votes": {"funny": 1, "useful": 1, "cool": 1}, "user_id": "r-t7IiTSD0QZdt8lOUCqeQ", "review_id": "0ESSqLfOae77muWTv_zUqA", "stars": 3, "date": "2011-02-11", "text": "Lately i have been feeling homesick for asian food and been hitting up places that i haven't been to in awhile.  Recently re-visited Thai Pan for a quick lunch and quickly ordered without spending too much time perusing the menu.  It looked more diverse than I remembered including some Vietnamese additions.  I remembered the curries and stir-fry dishes were ok but nothing really memorable.  A quick summary for my latest visit:\n\nPros:\n- convenient order-at-the counter setup\n- self-serve drink station\n- brown and white rice mixture\n- friendly and gracious owners\n\nCons:\n- too much napa cabbage in comparison to green vegetables \n- wish the owner/chef would be back in the kitchen vs. managing\n- spice level on the weak side", "type": "review", "business_id": "WIcDFpHEnC3ihNmS7-6-ZA"}
    return render_to_response('OperationRepo/review.html', context_dict, context)

def review2(request):
    context = RequestContext(request)
    context_dict = {"votes": {"funny": 0, "useful": 0, "cool": 0}, "user_id": "SS85hfTApRnbTPcJadra8A", "review_id": "VyAKIaj_Rmsf_ZCHcGJyUw", "stars": 5, "date": "2010-05-30", "text": "I love Marilo!  She understands my hair type and knows exactly what to do with my hair.  She keeps a record of my previous visits.  She recommends what is best for my hair.  She is pleasant to work with: easygoing, friendly, and respectful.  I've been going to her since 2008.  I'm really picky with hair people, and I used to go back to Chicago for haircuts.  Now, I stick to Marilo.", "type": "review", "business_id": "70p94Ejeu1v5XlIkbKORYQ"}
    return render_to_response('OperationRepo/review.html', context_dict, context)

def review3(request):
    context = RequestContext(request)
    context_dict = {"votes": {"funny": 0, "useful": 0, "cool": 0}, "user_id": "xAVu2pZ6nIvkdHh8vGs84Q", "review_id": "DusrkpkTGPGkqK13xO1TZg", "stars": 3, "date": "2011-11-26", "text": "Standard Chipotle fare - consistently good; not bad for corporate food - if you have a few minutes, there are a number of good local offerings within walking distance.", "type": "review", "business_id": "WcGTSRku3mrVK7V9GKq4UQ"}
    return render_to_response('OperationRepo/review.html', context_dict, context)
